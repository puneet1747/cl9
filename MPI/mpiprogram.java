...
public class mpiprogram {
    public static void main(String args[]) {
        ...
        MPI.Init(args);
        // takes a reference to the command line arguments
        int root = 0;
        // Rank and Size
        int size = MPI.COMM_WORLD.Size(); // Whenever program is ran in mpi all processes are grouped in an
                                          // communicator.
        ...
        // Declaring receive buffer
        // scatter (it sends chunk of array to different processes)
        // (Send buffer, Start of the data in buffer,chunk size,datatype)
