...
def help():
	return jsonify({'Routes available': [{'name': 'addwin', 'method':
	'POST'},{'name': 'addloss', 'method': 'POST'}, {'name': 'addtie', 'method':
	'POST'}, {'name': 'score', 'method': 'GET'}]})
...
# 1349  python3 -m venv venv
# 1350  source venv/bin/activate
# 1351  pip install Flask
# 1352  python -m flask --version\n
#  export FLASK_APP=as7
# 1360  flask run
# 1361  deactivate
